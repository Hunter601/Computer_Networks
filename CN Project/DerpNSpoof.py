...
def menu():
    ...
    print (colors['WARNING']+"  ||   | |   ||   __| ___  ___  ___ |  _|"+colors['ENDC'])
    print (colors['WARNING']+"  ||   | |--- |__   || . || . || . ||  _| "+colors['ENDC'])
    print (colors['WARNING']+" _||_  |_|    |_____||  _||___||___||_| "+colors['ENDC'])
    print (colors['WARNING']+"                     |_|                 "+colors['ENDC'])
    print ()
    print ("     --------------------------------------")
    print ("     --------------------------------------")
            ...
            if(line not in ['\n', '\r\n']):
                try:
                    ...
                    if (not valid_ip(value)):
                        print(colors['WARNING']+"    [!] Invalid IP address ["+value+"]"+colors['ENDC'])
                        sys.exit(1)
                except:
